function stateOutput = CCACubicWave(neighborState, LastNeighborState, WavePara, Nonlinearity)
    ...
    stateOutput = (2* stateCurrent - statePast) + 2 * WavePara * (stateAverage - stateCurrent + ...
         Nonlinearity * ((stateEast - stateCurrent)^3 - (stateCurrent - sWest)^3 + (stateNorth - stateCurrent)^3 - (stateCurrent - sSouth) ^3);
